...
fn deserialize_plus() {
    ...
    let test: Test = serde_structuredqs::from_str("email=a%2Bb%40c.com").unwrap();
...
fn deserialize_map_with_unit_enum_keys() {
    ...
    let test: Filter = serde_structuredqs::from_str("point[Gt]=123&point[Lt]=321").unwrap();
...
fn deserialize_map_with_int_keys() {
    ...
    let test: Mapping = serde_structuredqs::from_str("mapping[1]=2&mapping[3]=4").unwrap();
    ...
    serde_structuredqs::from_str::<Mapping>("mapping[1]=2&mapping[1]=4")
...
fn deserialize_unit_types() {
    ...
    let test: () = serde_structuredqs::from_str("").unwrap();
    assert_eq!(test, ());

    let test: A = serde_structuredqs::from_str("").unwrap();
    assert_eq!(test, A);

    let test: B = serde_structuredqs::from_str("a=test&t=").unwrap();
    assert_eq!(test, B { t: (), a: "test" });

    let test: B = serde_structuredqs::from_str("t=&a=test").unwrap();
    assert_eq!(test, B { t: (), a: "test" });
}
...
//     let serialized = serde_structuredqs::to_string(&data).unwrap();

//     dbg!(&serialized);
//     let deserialized = serde_structuredqs::from_str::<Data>(&serialized).unwrap();
